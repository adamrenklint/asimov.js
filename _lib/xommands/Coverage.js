...
module.exports = Test.extend({
  ...
  'runTests': function () {
    ...
    var path = npath.join(self.options.frameworkDir, 'node_modules/istanbul/lib/cli.js');
    var mochaPath = npath.join(self.options.frameworkDir, 'node_modules/mocha/bin/_mocha');
    var flags = [
      'cover',
      mochaPath,
      '--',
