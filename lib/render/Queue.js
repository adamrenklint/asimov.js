...
define([
  ...
  return Collection.extend({
    ...
    'render': function () {
      ...
      // ONLY ONE TyPE OF JOB PER RENDER!!
      ...
      while (size--) {
        ...
        self.trigger('rendering:' + job.attributes.type, job);
      ...
      self.when.call(self, promises).done(function () {
        ...
        var logString = 'Processsed ' + models.length + ' ' + models[0].attributes.type + ' job(s)';
        self.logger.since(self.namespace, logString, started);

        // _.each(groups, function (_models, group) {
        //   self.logger.
        // });
