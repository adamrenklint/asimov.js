...
define([
  ...
  return FilesystemCollection.extend({
    ...
    'initialize': function () {
      ...
      self.bindTo(self, 'change:position', _.debounce(self.sort, 1));
    },
    ...
    'comparator': function (model) {
      ...
      // this.logger.log('comparator', model.attributes.position)
      return model.attributes.position || 999999;
      // return parseInt(model.attributes.position, 10);
    },
