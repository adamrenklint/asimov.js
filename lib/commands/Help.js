...
module.exports = Command.extend({
  ...
  'commands': {
    ...
    'new [parent] [path]': 'Create class in [path], extending [parent]' + '\n\n      Example, extending a default class: asimov.js new Helper helpers/RelatedPosts\n      Available default classes: Base, Middleware, Initializer, Helper and Test\n\n      Example, extending a custom class: asimov.js new helper/RelatedPosts otherFolder/SmarterPosts'.grey,
