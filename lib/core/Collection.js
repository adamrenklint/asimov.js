/*
  ...
  collection class, forked from Backbone
...
define([
  ...
  var Collection = Base.extend({
    ...
    add: function (models, collection, options) {
      ...
      var result = self.set(models, _.defaults(options || {}, addOptions));
    ...
    set: function(models, options) {
      ...
      // from being added.
      this.logger.log('MODELS LENGTH??? ' + models.length);
      for (i = 0, l = models.length; i < l; i++) {
      ...
      this.logger.log('TO ADD LENGTH >>> ' + toAdd.length);
    ...
    _prepareModel: function(attrs, options) {
      ...
      this.logger.log('model count ++: '+ attrs.path);
      options || (options = {});
      ...
      this.logger.log('model return ++: '+ model.id);
      return model;
    },
