...
define([
  ...
  return Base.extend({
    ...
    'bootstrap': function () {
      ...
      // TODO: fix config - I think adding an initializer in the app project config will overwrite any initializers in this config? should do the same as with the middleware, just append the framework stuff?
