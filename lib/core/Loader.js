...
define([
...
], function (Base, Config, Cache, PageNodesCollection, SiteDataCollection, Watcher, Queue, TemplatesCollection, TemplateHelpers, Server, Signature) {
  ...
  return Base.extend({
    ...
    'bootstrap': function () {
      ...
      self.when(loadedPageNodes, loadedTemplates, loadedSiteData).done(function () {

        var pages = arguments[0][0];
        var templates = arguments[1][0];
        var siteData = arguments[2][0];
