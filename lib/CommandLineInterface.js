...
module.exports = Base.extend({
  ...
  'printVersion': function () {
    ...
    var self = this;
    var pkg = require(self.options.frameworkDir + '/package.json');
  ...
  'launchCommand': function (command) {
    ...
    if (command === '-v' || command === 'version') return self.printVersion();
    ...
    self.assert('function', fn, function () {
      ...
      var help = 'To get usage instructions, type ' + 'asimov help'.bold;
