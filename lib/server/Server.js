...
define([
  ...
  return Base.extend({
    ...
    'start': function () {
      ...
      var notFound = self.createMiddleware(NotFound);
    ...
    'resolveMiddleware': function (url) {
      ...
      var postMiddleware = ['DirectoryRouter'];

      var allMiddleware = preMiddleware.concat(configMiddleware, pageMiddleware, postMiddleware);
