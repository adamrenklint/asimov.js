  ...
  return Base.extend({
    ...
    'logRunning': function (display) {
      ...
      if (display) {
        ...
        self.logger.info(self.namespace, 'Server has been running ' + time.trim() + ', received ' + self.requestCount + ' requests and sent ' + (self.requestCount - self.errorCount) + ' non-error responses', false);
      }
