...
define([
  ...
  return DependencyParser.extend({
    ...
    'initialize': function () {
      ...
      self.assert('array', self.options.paths.styles, 'Cannot create StyleSheetParser without an array of paths to search for stylesheets in');
    },
    ...
    'parse': function (model, raw, dependencies) {
      ...
      console.log('match',match, 'raw', raw);
