...
define([
  ...
  '../updaters/ScriptHandler'

], function (Model, _, madge, StyleSheetParser, ScriptParser, PageParser, TemplateParser, PageHandler, TemplateHandler, StyleSheetHandler, ScriptHandler) {
  ...
  return Model.extend({
    ...
    'getPathType': function (path) {
      ...
      else if (self.filesystem.hasFileExtension(path, 'js')) {
        return 'script';
      }
    },
